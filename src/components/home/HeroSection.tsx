...
const SplineLoader = () => <div className="absolute inset-0 bg-background">
      ...
      <div className="relative w-full h-full">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3">
          <div className="flex gap-1">
            {[...Array(3)].map((_, i) => <motion.div key={i} className="w-2 h-2 rounded-full bg-accent" animate={{
            opacity: [0.3, 1, 0.3],
            scale: [0.8, 1.2, 0.8]
          }} transition={{
            duration: 1,
...
export const HeroSection = () => {
  ...
  return <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0">
        <AnimatePresence>
          {!isSplineLoaded && <motion.div initial={{
          opacity: 1
        }} exit={{
          opacity: 0
        }} transition={{
        ...
        ease: "easeOut"
          ...
          <Suspense fallback={null}>
            <Spline scene="https://prod.spline.design/M4lt5v1zkLC9BNwq/scene.splinecode" className="w-full h-full" onLoad={() => setIsSplineLoaded(true)} />
          </Suspense>
        </motion.div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(25)].map((_, i) => <motion.div key={i} className="absolute rounded-full" style={{
...
Transform Your Precious Moments Into Timeless Art.
        ...
        delay: 0.5
          ...
          icon: "👑"
        }].map((stat, index) => <motion.div key={index} className="text-center group" whileHover={{
          scale: 1.05
        }}>
      ...
      delay: 1
        ...
        repeat: Infinity
          ...
          <motion.div className="w-1.5 h-2.5 rounded-full bg-accent-gradient" animate={{
          opacity: [0.5, 1, 0.5]
        }} transition={{
          duration: 2,
          repeat: Infinity
